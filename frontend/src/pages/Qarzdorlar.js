  ...
  return (
    <div>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 24, flexWrap: 'wrap', gap: 12 }}>
        <div>
          <h2 style={{ fontSize: 22, fontWeight: 800, marginBottom: 2 }}>🧾 Qarzdorlar</h2>
      ...
      <div className="table-card">
        <div className="table-header">
          <h3 style={{ fontSize: 14, fontWeight: 700 }}>Barcha qarzdorlar</h3>
        ...
        {loading ? (
          ...
          <div className="empty-state">
            ...
            <h3>{search ? 'Topilmadi' : "Qarzdorlar yo'q"}</h3>
            <p>{search ? "Boshqa qidiruv so'zi kiriting" : "Birinchi qarzdorni qo'shing"}</p>
          </div>
        ) : (
          <table>
            <thead>
